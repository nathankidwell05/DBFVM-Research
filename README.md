...
[solver guide](reports/d1v5_guide/d1v5_kt_solver_guide.pdf).) To do a faster test without editing the
...
| [`reports/d1v5_guide/`](reports/d1v5_guide/) | Report on the solver with convergence study, order-of-accuracy discussion, and accuracy-versus-cost comparison with first-order and conventional Euler solvers |
